...
def sam_maskrcnn_eval(args, cfg, maskrcnn):
    maskrcnn.eval()
    ...
    DetectionCheckpointer(sam).load(args.sam_model_weight)
...
def main(args):
    ...
    sam_maskrcnn_eval(args, cfg, model)


if __name__ == "__main__":
    parser = default_argument_parser()
    parser.add_argument("--dataset", type=str, default="dataset")
    parser.add_argument("--mvitv2", type=str, help="path to mvitv2 checkpoint")
    parser.add_argument("--sam", type=str, help="path to sam checkpoint")
    ...
    args.seed = 1129
    args.output_dir = (
        "experiments/sam_maskrcnn_with_finetune/results/{}/mvitv2_b_in21k".format(
            args.dataset
        )
    )
    args.box_checkpoint = args.mvitv2
    args.mask_checkpoint = args.mvitv2
    args.sam_model_weight = args.sam
